package com.mango.es.mangoes.service;

import com.alibaba.fastjson.JSON;
import com.mango.es.mangoes.entity.UserInfo;
...
public class IndexService {
    ...
    public void addDocument() {
        try {
            // 创建索引请求对象
            IndexRequest indexRequest = new IndexRequest("user", "doc", "1001");
            // 创建员工信息
            UserInfo userInfo = new UserInfo();
            userInfo.setName("张三");
            userInfo.setSex("男");
            userInfo.setTel("13095986139");
//            userInfo.setAge(29);
...
//            userInfo.setBirthDate("1990-01-10");
    ...
    public void getDocument() {
        try {
            // 获取请求对象
            GetRequest getRequest = new GetRequest("user", "_doc", "1001");
            // 获取文档信息
    ...
    public void updateDocument() {
        try {
            // 创建索引请求对象
            UpdateRequest updateRequest = new UpdateRequest("user", "doc", "1");
            // 设置员工更新信息
            UserInfo userInfo = new UserInfo();
            userInfo.setTel("123456897");
